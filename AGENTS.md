...
**Automatic context management to stay under token limits:**

**Trigger:** When session approaches 90k tokens (90% of 100k limit)

**Process:**
1. Identify compressible content:
   - Tool outputs >1000 characters
   - Repeated information
   - Old conversation context (>20 turns ago)

2. Compression strategies:
   - Summarize verbose tool outputs
   - Remove duplicate information
   - Consolidate related messages
   - Preserve important decisions/learnings
...
4. Store compressed summaries in `MEMORY.md`

**Quality check:** Ensure no critical information lost during compression
